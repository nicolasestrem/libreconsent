...
|------|-------|-------|---------|
| 2026-07-26 | Codex | Phase 0 scaffold | Added pnpm workspace tooling, four typed stubs, static fixtures, CI gates, size budgets, NO_TCF, and traceability header. Local `pnpm check` is green; GitHub Actions pending. |
