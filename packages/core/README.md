...
[`@libreconsent/worker-log`](https://github.com/nicolasestrem/libreconsent/tree/v1.1.1/packages/worker-log#readme).
...
[`specs/US_NOTES.md`](https://github.com/nicolasestrem/libreconsent/blob/v1.1.1/specs/US_NOTES.md).
